...
export function CreatePlan() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="mb-6 text-lg font-semibold">新建学习计划</h1>
      ...
      <textarea
        ...
        className="mb-4 w-full rounded-md border border-gray-300 p-3 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      />
